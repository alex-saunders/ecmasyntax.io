    ...
    return (
        ...
        >
          <Link
            ...
            className={`${headerStyles['header-icon']} ${s['icon--search']}`}
            >
            <span>search</span>
          ...
          <button
            className={`${headerStyles['header-icon']} ${s['icon--close']}`}
            onClick={this.clearInput}
            ref={(btn) => { this.closeIcon = btn; }}
            aria-label="clear"
          >

            <svg fill="#fff" height="20" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
export default withStyles(s, headerStyles)(SearchInput);
