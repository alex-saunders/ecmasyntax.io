...
import { RUNTIME_CACHE }  from '../client/utils/constants';
import manifest           from '../../dist/client/static/js/manifest.json';
import App                from '../client/app';
import allReducers        from '../client/reducers/index';
...
router.get('/sw.js', async (req, res) => {
  ...
  const input = fs.createReadStream(path.join('dist', 'client', 'sw.js'));
